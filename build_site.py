...
@media (max-width:780px) {
  ...
  #navtoggle { display:inline-flex; align-items:center; gap:7px; position:fixed;
    ...
    /* solid --bg ring carves a clean buffer so scrolling content never
       appears to touch the button; the soft drop shadow keeps it floating. */
    box-shadow:0 0 0 7px var(--bg), 0 2px 12px rgba(0,0,0,.26); cursor:pointer; }
